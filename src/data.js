...
export const PROJECTS = [
  ...
  },
  {
    ...
    category: 'Marine Safety & Supplies',
    platform: 'MODX',
    stack: 'modx',
  },
  {
  ...
  /* ---- Custom-coded sites — hand-built in VS Code (with Claude Code),
     versioned in Git, and deployed to the PrimeTel server. No CMS. ---- */
  {
    slug: 'albaflux',
    name: 'Albaflux',
    url: 'https://albaflux.com/',
    category: 'Maritime Trade',
    platform: 'Custom · VS Code',
    stack: 'custom',
  },
  {
    slug: 'seaflux',
    name: 'Seaflux Logistics',
    url: 'https://seaflux.global/',
  ...
  {
    slug: 'boltcargo',
    name: 'BoltCargo Logistics',
    url: 'https://bltc.global/',
  ...
  {
    slug: 'bluesky-cargo',
    name: 'Blue Sky Cargo Logistics',
    url: 'https://bscl.global/',
    category: 'Marine Logistics',
    platform: 'Custom · VS Code',
    stack: 'custom',
  },
  {
    slug: 'tideway-cargo',
    name: 'Tideway Cargo Logistics',
    url: 'https://tidecl.global/',
    category: 'Marine Logistics',
    platform: 'Custom · VS Code',
    stack: 'custom',
  },
  {
    slug: 'zenglobal',
    name: 'ZenGlobal Cargo Logistics',
    url: 'https://zencl.global/',
    category: 'Marine Logistics',
    platform: 'Custom · VS Code',
    stack: 'custom',
  },
